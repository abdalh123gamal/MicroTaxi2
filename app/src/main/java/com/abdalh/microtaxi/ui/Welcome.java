    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location_switch.setOnCheckedChangeListener(new MaterialAnimatedSwitch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(boolean isOnline) {
                ...
                /*    displayLocation();*/
                    Snackbar.make(mapFragment.getView(),"أنت الأن أونلاين ومتاح لاستقبال طلبات الركاب ",Snackbar.LENGTH_SHORT).show();
                }
                else{
                    stopLocationUpdates();
                 /*   mCurrent.remove();*/
                    Snackbar.make(mapFragment.getView(),"أنت الأن أوفلاين",Snackbar.LENGTH_SHORT).show();
